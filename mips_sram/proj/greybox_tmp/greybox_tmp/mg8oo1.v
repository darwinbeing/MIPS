//alt3pram CBX_SINGLE_OUTPUT_FILE="ON" INDATA_ACLR="OFF" INDATA_REG="INCLOCK" INTENDED_DEVICE_FAMILY=""Cyclone II"" LPM_FILE="../test_data/RAM2.mif" LPM_TYPE="alt3pram" NUMWORDS=1024 OUTDATA_ACLR_A="OFF" OUTDATA_ACLR_B="OFF" OUTDATA_REG_A="UNREGISTERED" OUTDATA_REG_B="UNREGISTERED" RAM_BLOCK_TYPE="M4K" RDADDRESS_ACLR_A="OFF" RDADDRESS_ACLR_B="OFF" RDADDRESS_REG_A="INCLOCK" RDADDRESS_REG_B="INCLOCK" RDCONTROL_ACLR_A="OFF" RDCONTROL_ACLR_B="OFF" RDCONTROL_REG_A="UNREGISTERED" RDCONTROL_REG_B="UNREGISTERED" WIDTH=8 WIDTHAD=10 WRITE_ACLR="OFF" WRITE_REG="INCLOCK" data inclock qa qb rdaddress_a rdaddress_b wraddress wren
